...
// Μεταφορά των Enums στην αρχή και ΕΚΤΟΣ namespace για μέγιστη συμβατότητα με τα Blocks
enum Κατεύθυνση {
    //% block="Μπροστά"
    Forward,
    //% block="Πίσω"
...
namespace airbit2_GR {
     ...
     * @param κατεύθυνση επιλογή κατεύθυνσης από μενού
     ...
     * @param στροφή επιλογή δεξιά ή αριστερά
