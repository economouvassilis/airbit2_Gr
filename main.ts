...
namespace airbit2_GR {
     ...
     /**
     * Απαραίτητη διαδικασία μόνο (κατά την έναρξη)
     */   
    //% block="Αρχικοποίηση"
    ...
    /**
    * ΑΠΟΓΕΙΩΣΗ.
    * Η τιμή του ύψους είναι ενδεικτική και εξαρτάται
    * από την μπαταρία κ.λπ.
    */
    ...
    /**
    * 2. Αυτή η συνάρτηση μόνο εκτελεί 
    * (μπαίνει στο για πάντα)
    */
    ...
    /**
     * Παίζει ρόλο στην πτήση οπότε πρέπει να ενημερώνεται για πάντα
     */
    ...
    export function bobatteryCalculation() {
     ...
     /**
     * Aν το επίπεδο φόρτισης μπαταρίας πέσει κάτω από 20%
     * θα κάνει ένα βόμβο
     */
...
*/
    ...
    /**
     * Εκτελεί μια τετράγωνη οριζόντια διαδρομή
     */
...
*/
    ...
    */ 
    ...
    /**
     * Επιστρέφει την τιμή της μεταβλητής throttle 
     */
    ...
    /**
     * Επιστρέφει την τιμή πλήρωσης της μπαταρίας %. 
